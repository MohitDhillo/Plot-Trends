export const categories = [
    ...
    metrics: [
      {
        ...
        path: "/stocks/basic-financials",
        frequency: "annual",
      },
      {
        metricKey: "grossMargin",
        metricName: "Gross Margin (TTM)",
        path: "/stocks/basic-financials",
        frequency: "quarterly",
      },
      {
      ...
      {
        metricKey: "operatingMargin",
        metricName: "Operating Margin (TTM)",
        path: "/stocks/basic-financials",
        frequency: "quarterly",
      },
      {
      ...
      {
        metricKey: "pretaxMargin",
        metricName: "Pretax Margin (Annual)",
        path: "/stocks/basic-financials",
        frequency: "annual",
      },
      {
        metricKey: "pretaxMargin",
        metricName: "Pretax Margin (TTM)",
        path: "/stocks/basic-financials",
        frequency: "quarterly",
      },
      {
        metricKey: "roa",
        metricName: "ROA (Return on Assets) (RFY)",
        path: "/stocks/basic-financials",
        frequency: "annual",
      },
      {
        metricKey: "roaTTM",
        metricName: "ROA (Return on Assets) (TTM)",
        path: "/stocks/basic-financials",
        frequency: "quarterly",
      },
      {
        metricKey: "roe",
        metricName: "ROE (Return on Equity) (RFY)",
        path: "/stocks/basic-financials",
        frequency: "annual",
      },
      {
        metricKey: "roeTTM",
        metricName: "ROE (Return on Equity) (TTM)",
        path: "/stocks/basic-financials",
        frequency: "quarterly",
      },
      {
        metricKey: "roic",
        metricName: "ROI (Return on Invested Capital) (Annual)",
        path: "/stocks/basic-financials",
        frequency: "annual",
      },
      {
        metricKey: "roicTTM",
        metricName: "ROI (Return on Invested Capital) (TTM)",
        path: "/stocks/basic-financials",
        frequency: "quarterly",
      },
    ],
  },
  {
    ...
    metrics: [
      ...
      {
        metricKey: "peTTM",
        metricName: "P/E (Price to Earnings) Ratio (TTM)",
        path: "/stocks/basic-financials",
        frequency: "quarterly",
      },
      {
      ...
      {
        metricKey: "psTTM",
        metricName: "P/S (Price to Sales) Ratio (TTM)",
        path: "/stocks/basic-financials",
        frequency: "quarterly",
      },
    ...
    metrics: [
      {
        ...
        metricName: "Current Ratio (Annual)",
        path: "/stocks/basic-financials",
        frequency: "annual",
      },
      {
  ...
  },
  {
    ...
    metrics: [
      ...
      {
        metricKey: "assetTurnoverTTM",
        metricName: "Asset Turnover (TTM)",
        path: "/stocks/basic-financials",
        frequency: "quarterly",
      },
      {
  ...
  },
  {
    ...
    metrics: [
      ...
      {
        metricKey: "epsTTM",
        metricName: "EPS (Earnings Per Share) (TTM)",
        path: "/stocks/basic-financials",
        frequency: "quarterly",
      },
      {
  ...
  },
  {
    ...
    metrics: [
      ...
      },
      {
        ...
        metricName: "Payout Ratio (Annual)",
        path: "/stocks/basic-financials",
        frequency: "annual",
      },
    ],
